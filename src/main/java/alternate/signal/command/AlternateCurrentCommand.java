package alternate.signal.command;
...
import alternate.signal.util.profiler.ProfilerResults;
...
public class AlternateCurrentCommand {
	...
	public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
		LiteralArgumentBuilder<CommandSourceStack> builder = Commands.
			...
			then(Commands.
				...
				requires(source -> AlternateSignalMod.DEBUG).
	...
	private static int query(CommandSourceStack source) {
		String state = AlternateSignalMod.on ? "enabled" : "disabled";
